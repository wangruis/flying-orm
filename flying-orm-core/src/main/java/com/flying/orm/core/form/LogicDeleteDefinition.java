 ...
 * @version v1.0
 */
public record LogicDeleteDefinition(FieldIdentity identity, Object notDeletedValue, Object deletedValue) {
    ...
    public LogicDeleteDefinition(String fieldName, Object notDeletedValue, Object deletedValue) {
        this(FieldIdentity.of(fieldName), notDeletedValue, deletedValue);
    }

    /** @return 保留声明大小写的删除标记字段名 */
