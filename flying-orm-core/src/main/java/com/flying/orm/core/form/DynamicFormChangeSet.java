...
public record DynamicFormChangeSet(DynamicForm source,
    ...
    public DynamicFormChangeSet {
        ...
        addedFields = List.copyOf(Objects.requireNonNull(addedFields, "added fields must not be null"));
        removedFields = List.copyOf(Objects.requireNonNull(removedFields, "removed fields must not be null"));
        changedFields = List.copyOf(Objects.requireNonNull(changedFields, "changed fields must not be null"));
        ...
        if (!addedFields.equals(expectedAdded(source, target))
