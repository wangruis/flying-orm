...
class JdbcSqlExecutorParameterSnapshotTest {
    ...
    void ownsMutableBinaryValuesDuringSynchronousExecution() throws Exception {
        ...
        JdbcSqlExecutor sql = JdbcSqlExecutor.create(com.flying.orm.rdb.execution.ConnectionAccessTestSupport.jdbc(dataSource(bound, execute, observed)), RdbDialect.h2());
