...
class JdbcMappedQueryTerminalTest {
    ...
    void stopsAfterTheTerminalRowLimitAndMapsAfterClosingJdbcResources() throws Exception {
        ...
        JdbcSqlExecutor executor = JdbcSqlExecutor.create(com.flying.orm.rdb.execution.ConnectionAccessTestSupport.jdbc(countingDataSource(delegate, nextCalls, resultSetClosed)), RdbDialect.h2());
    ...
    void mapperFailureDoesNotTurnSuccessfulSqlIntoAnErrorObservation() throws Exception {
        ...
        JdbcSqlExecutor executor = JdbcSqlExecutor.create(com.flying.orm.rdb.execution.ConnectionAccessTestSupport.jdbc(countingDataSource(delegate, new AtomicInteger(), resultSetClosed)), RdbDialect.h2())
