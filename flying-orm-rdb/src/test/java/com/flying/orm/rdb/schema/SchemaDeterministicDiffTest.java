...
class SchemaDeterministicDiffTest {
    ...
    @Test
    void additionsFollowDeclarationOrderWhileOtherOperationsRemainDeterministic() {
        ...
        assertEquals(List.of(
                ...
                "DROP_COLUMN:bravo:COMPATIBLE_EXTRA"), signatures(first));
        assertEquals(List.of(
                "ADD_COLUMN:charlie:SAFE_INCREMENTAL",
                "ADD_COLUMN:delta:SAFE_INCREMENTAL",
                "DROP_COLUMN:alpha:COMPATIBLE_EXTRA",
                "DROP_COLUMN:bravo:COMPATIBLE_EXTRA"), signatures(second));
        assertEquals(signatures(first), signatures(SchemaDiffer.diff(
                desiredOne, SchemaSnapshot.present(actualTwo),
                DialectCapabilities.of(DialectCapabilityId.NATIVE_BOOLEAN,
                                       DialectCapabilityId.NATIVE_JSON),
                SchemaCompatibilityMode.SAFE_INCREMENTAL)));
    }
