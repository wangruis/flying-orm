...
class OperatorTemplatePlanReuseTest {
    ...
    void batchOptionDerivationReusesBothBackendTemplatePlans() throws Exception {
        assertDerivationReusesPlans(clients -> clients.withDefaultBatchWriteOptions(BatchWriteOptions.of(32)));
    }
    ...
    void derivedTemplateCallsReadTrustedParametersForEachSubscriptionAndSyncCall() throws Exception {
        ...
        try (FlyingOrmClients original = FlyingOrmClients.builder(ConnectionAccessTestSupport.jdbc(connections.dataSource()),
                ConnectionAccessTestSupport.reactive(connections.factory()))
    ...
    private static FlyingOrmClients clients(NoConnections connections, SqlTemplateRegistry registry) {
        return FlyingOrmClients.builder(ConnectionAccessTestSupport.jdbc(connections.dataSource()),
                ConnectionAccessTestSupport.reactive(connections.factory()))
