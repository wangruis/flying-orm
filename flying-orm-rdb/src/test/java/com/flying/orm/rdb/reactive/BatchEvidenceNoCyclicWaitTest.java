...
class BatchEvidenceNoCyclicWaitTest {
    ...
    void forwardingEvidenceReturnsBeforeAndWithoutRegisteringExternalCompletion() {
        ...
        ReactiveSqlExecutor delegate = R2dbcSqlExecutor.create(
                com.flying.orm.rdb.execution.ConnectionAccessTestSupport.borrowed(connection), RdbDialect.h2());
        ...
        assertEquals(1, evidence.successfulCount());
    }
