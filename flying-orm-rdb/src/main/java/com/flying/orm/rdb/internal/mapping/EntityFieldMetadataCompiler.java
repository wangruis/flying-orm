...
final class EntityFieldMetadataCompiler {
    ...
    static EntityFieldMetadata compile(Class<?> entityType,
        ...
        return new EntityFieldMetadata(field.getName(),
                                       columnName,
                                       EntityFieldTypeResolver.dataType(field, enumStorage, enumValue),
                                       primaryKey,
                                       isVersion(field),
    ...
    private static Optional<LogicDeleteValues> logicDelete(Field field,
        ...
        return classLogicDelete.filter(annotation -> EntityMetadataNames.matches(annotation.field(), field.getName())
                        || EntityMetadataNames.matches(annotation.field(), columnName))
