...
public final class SyncDatabaseOperator {
    ...
    public SyncSqlTemplateOperator sqlTemplate(String templateId) {
        SqlTemplate template = templates.template(templateId);
        return new SyncSqlTemplateOperator(executor,
                                           renderer.valueCodecs(),
                                           forms.entityModels(),
                                           templateEngine,
                                           template,
                                           templates.serverParameters(template.id()),
                                           templateParameters);
    }
    ...
    private SyncDatabaseOperator copy(SyncFormClient configuredForms,
        ...
        return new SyncDatabaseOperator(new NativeComponents(
                configuredForms, executor, renderer, configuredScope, dialect, configuredSchema,
                jdbcMetadata, metadata, metadataInvalidator, templates, templateParameters));
    }
