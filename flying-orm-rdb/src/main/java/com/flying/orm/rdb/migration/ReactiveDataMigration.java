 ...
 *
 * <p>这是跨数据库都能明确表达的数据级补偿，不声称 DDL 能自动恢复已经删除的数据。当前正向步骤没有返回
 * 可确认结果时状态是 {@link DataMigrationStatus#OUTCOME_UNKNOWN}；补偿失败时状态是
 * {@link DataMigrationStatus#ROLLBACK_FAILED}。两种情况都要求上层停止发布并人工核对。</p>
 *
 * @author wangr
 * @date 2026-08-03
 * @version v1.0
